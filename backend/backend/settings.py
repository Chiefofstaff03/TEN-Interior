...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'tech@entrepreneurshipnetwork.net')  # Replace with your Gmail
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'inpd gxpn msgp rbdx')  # Replace with your App Password
